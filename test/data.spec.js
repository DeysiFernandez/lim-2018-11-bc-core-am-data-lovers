...
describe('lol', () => {
    ...
    describe('lol.getChampions', () => {
        it('deberia ser una funcion', () => {
            expect(typeof window.lol.getChampions).toBe('function');
        });
        it('deberia retornar un array de objetos, con los atributos name y img', () => {
    ...
    describe('lol.filterRoleChampions', () => {
        ...
        it('deberia retornar un array con los campeones segun rol', () => {
            expect(window.lol.filterRoleChampions(input, filterType)).toEqual(output2);
        });
    });
});